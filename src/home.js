...
function Home() {
    return (
        <div className="home">
            ...
            <p className='title-paragraph'>Also, new addition is the <a href='http://localhost:3000/weather'>Weather</a> app. <br/>Enter a ZIP code to get the weather of the location, now diplaying State. </p>
        </div>
    );
}
