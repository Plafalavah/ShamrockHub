...
function Home() {
    return (
        <div className="home">
            ...
            <p className='title-paragraph'>Bouncing ball <a href='http://localhost:3000/simulation'>simulation. With each bounce the color changes. Simple, but good for learning Matter-js.</a></p>
        </div>
    );
}
