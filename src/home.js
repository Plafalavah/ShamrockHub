...
function Home() {
    return (
        <div className="home">
            ...
            <p className='title-paragraph'>Also, new addition is the <a href='http://localhost:3000/weather'>Weather</a> app. Working on adjusting it to allow for country selection!</p>
        </div>
    );
}
