...
function Home() {
    return (
        <div className="home">
            ...
            <p className='title-paragraph'><a href='http://localhost:3000/weather'>Weather</a> here! <br/>Enter a ZIP code to get the weather of the city in it's respective state. </p>
            <p className='title-paragraph'>In work: <a href='http://localhost:3000/simulation'>Simulation</a></p>
        </div>
    );
}
